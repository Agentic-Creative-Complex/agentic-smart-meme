...
import { subjects } from "../../constants/topics";
import { postOnTgChannels, sendTelegramMessage } from "../telegram/telegram.service";
import { sleep } from "../../utils/sleep";
import { Activity, ActivityChannel, ActivityType } from "../../db/models/Activity";
import { message } from "telegraf/src/filters";
import { Artwork } from "../../db/models/Artwork";

const MAX_REPLIES = Number(process.env.MAX_REPLIES) || 5;
